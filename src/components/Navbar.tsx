      ...
      >
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <motion.a
            ...
            className="flex items-center gap-3 text-xl font-bold perspective-1000"
          >
          ...
          <div className="hidden md:flex items-center gap-8">
            {navLinks.map((link) => (
              <motion.a
                key={link.name}
                href={link.href}
                className="text-gray-700 dark:text-gray-300 hover:text-cyan-500 dark:hover:text-cyan-400 font-medium transition-colors relative group perspective-1000 menu-3d"
                whileHover={{
                  rotateX: 10,
                  rotateY: 5,
                  scale: 1.05,
              ...
              >
                ...
                <motion.span 
                  className="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-cyan-500 to-purple-600 transition-all group-hover:w-full"
                  whileHover={{
                    scaleY: 2,
            ...
            <motion.a
              href="/contact"
              className="px-6 py-2.5 bg-gradient-to-r from-cyan-500 to-purple-600 text-white font-semibold rounded-full hover:shadow-lg hover:shadow-cyan-500/30 transition-all duration-300 relative preserve-3d"
              whileHover={{
                rotateX: 15,
                rotateY: 10,
                scale: 1.05,
